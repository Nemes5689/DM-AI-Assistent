        ...
        <>
          ...
          <nav style={{
            ...
            {[
              ...
              { id: 'loot', label: 'Loot Forge', icon: CoinIcon },
            ].map(t => (
              <button
                key={t.id}
...
// =============================================================================
// COIN ICON (custom SVG for Loot Forge tab)
// =============================================================================
const CoinIcon = ({ size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size} height={size}
    viewBox="0 0 24 24" fill="none"
...
// =============================================================================
// TAB 6: LOOT FORGE (embedded shop & treasure generator)
// =============================================================================
const LOOT_HTML_B64 = "";
...
function LootTab() {
  return (
    <div>
      ...
      <div style={{ marginBottom: '16px', textAlign: 'center', color: palette.textDim, fontSize: '13px', fontStyle: 'italic' }}>
        Generate shop inventories, treasure hoards, monster loot, and pickpocket finds — calibrated to party tier.
      </div>
      ...
      <div style={{
        ...
        <button
          onClick={() => {
            const win = window.open('', '_blank');
            if (win) {
              win.document.write(atob(LOOT_HTML_B64));
              win.document.close();
            }
          }}
          className="btn-secondary"
        ...
        <iframe
          src={`data:text/html;base64,${LOOT_HTML_B64}`}
          title="Loot Forge"
          style={{
            width: '100%',
            height: '900px',
